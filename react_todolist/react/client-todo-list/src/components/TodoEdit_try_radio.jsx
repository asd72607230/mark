...
class TodoEdit extends Component {
    ...
    setIsCompleteToTrue = (e) => {
        var newState = { ...this.state };
        newState.todoItem.isComplete = true;
        this.setState(newState);
    }
    setIsCompleteToFalse = (e) => {
        var newState = { ...this.state };
        newState.todoItem.isComplete = false;
        this.setState(newState);
    }
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-8">
                                    <div className="custom-control custom-radio custom-control-inline">
                                        <input name="" id="_0" type="radio" className="custom-control-input"
                                            value="yes" checked={this.state.todoItem.isComplete ? "checked" : ""}
                                            onChange={this.setIsCompleteToTrue}
                                        />
                                        <label htmlFor="_0" className="custom-control-label">Finished</label>
                                    </div>
                                    <div className="custom-control custom-radio custom-control-inline">
                                        <input name="" id="_1" type="radio" className="custom-control-input" value="no"
                                            checked={this.state.todoItem.isComplete ? "" : "checked"}
                                            onChange={this.setIsCompleteToFalse}
                                        />
